        ...
        <tr>
            <td>
				<table style="background:#fff;border: 1px solid #41afb0;width: 100%;height: 100%; position:relative;">
					<tr>
						<td>
							<div class="titleMain">Estimado(a) Doctor(a) ${Doctor.fullName}</div>
          ...
          <tr style="text-align: center;font-size: 12px;">
            <td>
              <div class="" >Por favor si tiene algun inconveniente con la cita programada llamar al 999 999 999</div>
            </td>
          </tr>
