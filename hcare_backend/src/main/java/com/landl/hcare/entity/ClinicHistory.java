...
public class ClinicHistory extends AuditModel {
    @Id
    @GeneratedValue(generator = "clinic_history_generator")
    @SequenceGenerator(
            name = "clinic_history_generator",
            sequenceName = "clinic_history_sequence",
            initialValue = 1000
    )
    private Long id;
